            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline">
                <a
                  href="/"
                  :class="[
                    currentPage == '/' ? 'text-white bg-gray-900' : '',
                    'text-gray-300',
                  ]"
                ...
                <a
                  :class="[
                    currentPage == '/table' ? 'text-white bg-gray-900' : '',
                    'text-gray-300',
                  ]"
                  href="/table"
                ...
                <a
                  :class="[
                    currentPage == '/dropdown' ? 'text-white bg-gray-900' : '',
                    'text-gray-300',
                  ]"
                  href="/dropdown"
                  class="ml-4 px-3 py-2 rounded-md text-sm font-medium hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700"
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div class="ml-3 relative">
                <div>
                  <button
                    v-on:click="profileDropdown = !profileDropdown"
                    v-click-outside="toggleProfileDropdown"
